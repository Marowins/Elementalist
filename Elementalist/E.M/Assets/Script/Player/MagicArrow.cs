...
public class MagicArrow : MonoBehaviour {
	...
	void Start()
	{
		...
		playerState = GameObject.Find ("Player").GetComponent<PlayerController> ().element;

		targetPos = (GameObject.Find ("Player").GetComponent<PlayerController> ().mousePos - transform.position).normalized;
	}
